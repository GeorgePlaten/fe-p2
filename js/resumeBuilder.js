// Add content Objects with Encapsulted display functions
var bio = {
  "name": "George Platen",
  ...
  "display": function() {
    ...
    for (var contactKind in bio.contacts) {
      ...
      // again, html shouldn't be here, but instructors seem to prefer
